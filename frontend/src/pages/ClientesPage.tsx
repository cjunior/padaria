...
export default function ClientesPage() {
  ...
  return (
    <div className="page">
      ...
      <DataTable load={clientesService.list} reloadToken={reloadToken} columns={[{"key":"id","label":"id"},{"key":"nome","label":"nome"},{"key":"telefone","label":"telefone"},{"key":"email","label":"email"}]} idKey={"id"} fields={[{"name":"nome","type":"text","required":true,"readOnly":false},{"name":"telefone","type":"text","required":false,"readOnly":false},{"name":"email","type":"email","required":false,"readOnly":false}]} onUpdate={clientesService.update} onDelete={clientesService.remove} />
        ...
        <div className="dialog-overlay" role="presentation" onClick={closeCreateDialog}>
          ...
          >
            ...
            <ApiForm
              ...
              fields={[{"name":"nome","type":"text","required":true,"readOnly":false},{"name":"telefone","type":"text","required":false,"readOnly":false},{"name":"email","type":"email","required":false,"readOnly":false}]}
